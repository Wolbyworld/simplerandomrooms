(() => {
    ...
    const messages = {
        en: {
            ...
            home: {
                eyebrow: "A fair call, without the fuss",
                titleLineOne: "Set the rules.", titleLineTwo: "Make the draw.",
                lede: "Draw alone now, or share the room and decide together. Every result stays on the record.",
                deskLabel: "Referee's desk", setupTitle: "What are we deciding?", modeLegend: "Draw type", presets: "Quick setups",
        ...
        es: {
            ...
            home: {
                eyebrow: "Una decisión justa, sin complicaciones",
                titleLineOne: "Pon las reglas.", titleLineTwo: "Haz el sorteo.",
                lede: "Sortea ahora a solas o comparte la sala para decidir en grupo. Cada resultado queda registrado.",
                deskLabel: "Mesa del árbitro", setupTitle: "¿Qué vamos a decidir?", modeLegend: "Tipo de sorteo", presets: "Preparaciones rápidas",
